...
const UserReviews = () => {
  ...
  useEffect(() => {
    fetch('https://triptastic-n3e0.onrender.com/fetchReview') // This will make a request to the backend endpoint
  ...
  const insert_data = async (data) => {
    const response = await fetch("https://triptastic-n3e0.onrender.com/insertReview",{
      method: "post",
